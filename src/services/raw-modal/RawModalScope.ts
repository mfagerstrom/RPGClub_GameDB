...
export const RAW_MODAL_SUPPORTED_FEATURES = ["todo"] as const;
...
export type RawModalFlow = RawModalTodoPilotFlow;
...
export const RAW_MODAL_PILOT_FEATURE: RawModalFeature = "todo";
